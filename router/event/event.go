...
func GetAllEventsHandler(db *sql.DB) func(*gin.Context) {
	return func(c *gin.Context) {
		...
		c.IndentedJSON(http_error.GetStatusCode(err), events)
	}
}
...
func UpdateEventHandler(db *sql.DB) func(*gin.Context) {
	return func(c *gin.Context) {
		...
		c.IndentedJSON(http_error.GetStatusCode(err), updatedEvent)
	}
}
...
func LeaveDeleteAllEventsHandler(db *sql.DB) func(*gin.Context) {
	return func(c *gin.Context) {
		...
		c.IndentedJSON(http_error.GetStatusCode(err), eventsWithUsers)
	}
}
