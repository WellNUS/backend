...
func TestMain(m *testing.M) {
	...
	if err != nil {
		log.Fatal(fmt.Sprintf("Something went wrong when creating match settings. %v", err))
	}
	...
	if err != nil {
		log.Fatal(fmt.Sprintf("Something went wrong when creating Match Request. %v", err))
	}
